...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="text-dark text-center mb-5">Book an appointment</h3>
                
                    <div>
                        <form action="dbhandler.php" method="POST">
                          <div class="input-group input-group-sm mb-3">
                           <span class="input-group-text span text-blue border border-dark" id="inputGroup-sizing-sm"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                           <input type="text" class="form-control" name="email"  placeholder="Enter Email" aria-describedby="inputGroup-sizing-sm">
                         </div>
                          ...
                          <div class="form-group text-center">
                            <button type="submit" value="update" class="btn btn-primary" name="update_data">Update</button>
                          </div>
                          <div class="form-group text-center">
